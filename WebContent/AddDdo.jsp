...
<head>
	...
	<title><fmt:message key="admin_dashboard"/></title>
	    ...
	    <div class="sidebar" data-color="blue" data-image="assets/img/sidebar-1.jpg">
			...
			<div class="logo">
				<a href="" class="simple-text">
					<fmt:message key="Admin"></fmt:message>
				</a>
			</div>
	            ...
	            <ul class="nav">
	                <li class="">
	                    <a href="ViewAllDdos">
	                        ...
	                        <p><b><fmt:message key="ViewDdos"/></b></p>
	                    </a>
	                </li>
	                 <li class="">
	                 ...
	                 <li class="active">
	                    <a href="AddDdo.jsp">
	                        <i class="material-icons">dashboard</i>
	                        <p><b><fmt:message key="Add_Ddo"></fmt:message></b></p>
	                    </a>
	                </li>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li>
								<a href="Admin.jsp" ><!-- class="dropdown-toggle" data-toggle="dropdown" -->
									<i class="material-icons">dashboard</i>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            ...
	                            <div class="card-content">
	                                <form action="AddDdoServlet" method="post">
	                                    <div class="row">
	                                        <div class="col-md-5">
												<div class="form-group label-floating">
													<label class=""><fmt:message key="districtname"/></label>
	                                     ...
	                                     <div class="row">
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
													<label class=""><fmt:message key="appointment_letter_no"/></label>
								  		...
								  		<%--  <label class=""><fmt:message key="appointment_type"/></label>
	                                       ...
	                                       <%--  <div class="row"> 
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group ">
													<label class=""><fmt:message key="join_date"/></label>
	                                       ...
	                                       <div class="row"> 
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
													<label class=""><fmt:message key="District_Id"/></label>
													<input type="text" name="districtId" class="form-control" >
												</div>
	                                        </div>
	                                       </div>
