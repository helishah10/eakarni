...
<fmt:bundle basename="com.zensoftech.eakarni.properties.AddTDO" prefix="">
				...
				<ul class="nav">
	                ...
	                <li class="active">
	                    <a href="ViewAllTdosServlet">
	                        <i class="material-icons">person</i>
	                        <p style="text-align:center"/><fmt:message key="page.nav3"/></p>
	                    </a>
	                </li>
	                <li>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li>
								<a href="DDO.jsp" ><!-- class="dropdown-toggle" data-toggle="dropdown" -->
									<i class="material-icons">dashboard</i>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title"><fmt:message key="Add_Profile"/></h4>
									<p class="category"><fmt:message key="Add_TDO_Details"/></p>
	                            </div>
	                            <div class="card-content">
	                                <form action="AddTdoServlet" method="post">
	                                    <div class="row">
	                                        <div class="col-md-5">
												<div class="form-group label-floating">
													<label class="control-label"><fmt:message key="Taluka_Name"/></label>
													<input type="text" name="talukaName" class="form-control" >
												</div>
	                                        </div>
	                                     </div>
	                                     <div class="row">
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
													...
													<input type="text" name="appointmentLetterNo" class="form-control" >
												</div>
	                                        </div>
	                                       </div>
	                                     ...
	                                     <%--    <label class=""><fmt:message key="appointment_type"/></label>
	                                        ...
	                                        <div class="col-md-4">
												<div class="form-group">
													 ...
													 <label class="">permanent<input type="radio" name="appointmentType" class="form-control" value="true" ></label>
													 <label class="">temporary<input type="radio" name="appointmentType" class="form-control" value="false" ></label>
	                                       ...
	                                       <div class="row"> 
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
													<label class="control-label"><fmt:message key="Taluka_Id"/></label>
													<input type="text" name="talukaId" class="form-control" >
												</div>
	                                        </div>
	                                       </div>
	                                    ...
	                                    <button type="submit" name="submit" class="btn btn-primary pull-right"><fmt:message key="page.submit"></fmt:message></button>
