...
<head>
	...
	<title><fmt:message key="admin_dashboard"></fmt:message></title>
				...
				<div class="container-fluid">
					 <div class="row">
	                    ...
	                    <a href="ViewAllDdos">
	                        ...
	                        <p><h4></b><fmt:message key="ViewDdos"></fmt:message></h4></p>
	                    </a>
	                </li>
							</div>
						</div>
					...
					<div class="row">
	                   ...
	                   <a href="AdminUser.jsp">
	                         ...
	                         <p><h4></b><fmt:message key="User_Profile"/></h4></p>
					...
					<div class="row">
	                    ...
	                    <a href="AddDdo.jsp">
	                        ...
	                        <p><h4></b><fmt:message key="Add_Ddo"/></h4></p>
					...
					<div class="row">
	                    ...
	                    <a href="AddUser.jsp">
	                        ...
	                        <p><h4></b><fmt:message key="Add_user"/></h4></p>
