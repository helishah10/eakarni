								...
								<tbody> 
	          					<tbody>
								   <% int i = 1; %>
	          					  ...
	          					  <tr>
	          					 	<td><%= i %> <% i++; %></td>
									<td>${financeentry.totalWork}</td>
									<td>${financeentry.worksApproved}</td>
									<td>${financeentry.projectNotStarted}</td>
									<td>${financeentry.progress}</td>
									<td>${financeentry.completed}</td>
									<td>${financeentry.grantAllocated}</td>
									<td>${financeentry.amountSpent}</td>
								</tr>
