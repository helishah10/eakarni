						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title" style="text-align:center;font-weight:bold;">Gram Svagat</h4>
	                                ...
	                                <table class="table table-hover">
	                                    <thead class="text-warning" style="color:blue;font-weight:900px;">
	                                        <tr>
												...
												<th class="" style="">ગ્રામ સ્વાગત માં રજુ થયેલ પ્રશ્નો ની ટુકી વિગત  </th>
												<th class="" style="">નિકાલ </th>
												<th class="" style="">બાકી </th>
											</tr>
	                                    ...
	                                    <tbody>
	          					 		 ...
	          					 		 <tr>
												...
												<td>${gramswagatentry.descriptionOfQuestionsRaised}</td>
												<td>${gramswagatentry.disposal }</td>
												<td>${gramswagatentry.pending }</td> 
	            				 		</tr> 
