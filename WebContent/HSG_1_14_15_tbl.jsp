							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
									...
									<td style="text-align: CENTER;">1</td>
	                                        	...
	                                        	<td >${hsg1415.notStartedHouses }</td>
	                                        	<td >${hsg1415.plinthLevel }</td>
	                                        	<td >${hsg1415.lintalLevel }</td>
	                                        	<td >${hsg1415.slabLevel }</td>
	                                        	<td>${hsg1415.completedHouses }</td>
	                                        	<td>${hsg1415.target}</td>
									</tr>
