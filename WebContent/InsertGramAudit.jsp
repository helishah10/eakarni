...
<fmt:bundle basename="com.zensoftech.eakarni.properties.InsertGP_Audit" prefix="">
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
	    ...
	    <div class="sidebar" data-color="blue" data-image="assets/img/sidebar-1.jpg" style="">
			...
			<div class="logo">
				...
				<i class="material-icons">view_list</i>
					<fmt:message key="Gram_Audit_Para"></fmt:message>
				</a>
			</div>
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="blue">
	                                <h4 class="title" style="text-align:center;font-weight:bold;"><fmt:message key="Gram_Audit_Para"></fmt:message></h4>
	                                
	                            </div>
	                            <div class="card-content table-responsive">
	                                <form class="well form-horizontal" action="InsertGramAuditServlet" method="post"  id="contact_form">
								<fieldset>
								
								
								
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="yearOfRegisteration"/></label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="yearOfRegisteration" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="totalPera"/></label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="totalPera" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4 control-label" ><fmt:message key="totalPeraAnswered"/></label> 
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="totalPeraAnswered" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								...
								<!-- Text input-->
								       <div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="totalPeraAnsweredThisWeek"/> </label>  
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								        <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="totalPeraAnsweredThisWeek" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								...
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="peraNotanswered"/></label>  
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								        <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="peraNotanswered" placeholder="" class="form-control" type="text" disabled>
								    </div>
								  </div>
								</div>
