						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="blue">
	                                <h4 class="title" style="text-align:center;font-weight:bold;"><fmt:message key="IAY"/></h4>
	                                
	                            </div>
	                            <div class="card-content table-responsive">
	                                <form class="well form-horizontal" action="/eakarni/InsertIayServlet" method="post"  id="contact_form">
								<fieldset>
								...
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="firstInstallment"></fmt:message></label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="firstInstallment" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4 control-label" ><fmt:message key="secondInstallment"/> </label> 
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="secondInstallment" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								...
								<!-- Text input-->
								       <div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="thirdInstallment"/></label>  
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								        <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="thirdInstallment" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
							...
							<option value="12">December
								...
								<button data-background-color="blue" type="sumit" class="btn btn-large btn-primary" >Submit</button>
