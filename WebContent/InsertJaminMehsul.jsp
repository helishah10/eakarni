...
<fmt:bundle basename="com.zensoftech.eakarni.properties.InsertJaminMehsul" prefix="">
<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8" />
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <form class="well form-horizontal" action="InsertJaminMehsulServelt" method="post"  id="contact_form">
								<fieldset>
								
								
								
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="landRevenue"/></label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="landRevenue" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="totalAmountSeeking"/></label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="totalAmountSeeking" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4 control-label" ><fmt:message key="amountCollectedDuringMonth"/> </label> 
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="amountCollectedDuringMonth" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								...
								<!-- Text input-->
								       <div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="amountLeft"/></label>  
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								        <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="amountLeft" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								...
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="percentage"/></label>  
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								        <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="percentage" placeholder="" class="form-control" type="text">
								    </div>
								  </div>
								</div>
							...
							<option value="12">December
								...
								<div class="form-group">
								  <label class="col-md-4 control-label"><fmt:message key="year"/></label>  
								    ...
								    <div class="input-group">
								        <span class="input-group-addon"><i class=""></i></span>
								  <input style="width:120px;height:20px" name="year" placeholder="" class="form-control" type="year">
								    </div>
								  </div>
								</div>
