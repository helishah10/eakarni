					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								...
								<div class="form-group">
								  <label class="col-md-4" style="font-weight:bold;color:black;">Occupant name</label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input value="" style="width:120px;height:20px" name="Occupant_name" placeholder="" class="form-control"  type="text" >
								    </div>
								  </div>
								</div>
