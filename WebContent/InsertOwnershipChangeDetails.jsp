						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="blue">
	                                <h4 class="title" style="text-align:center;font-weight:bold;">Create Property</h4>
								...
								<div class="form-group">
								  <label class="col-md-4" style="font-weight:bold;color:black;">Property id</label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input value="" style="width:120px;height:20px" name="Property_ids" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4" style="font-weight:bold;color:black;">new owner</label>  
								  <div class="col-md-4 inputGroupContainer">
								  <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input value="" style="width:120px;height:20px" name="new" placeholder="" class="form-control"  type="text" >
								    </div>
								  </div>
								</div>
								
								<div class="form-group">
								  <label class="col-md-4" style="font-weight:bold;color:black;" >Attachment</label> 
								    <div class="col-md-4 inputGroupContainer">
								    <div class="input-group">
								  <span class="input-group-addon"><i class=""></i></span>
								  <input value="" style="width:120px;height:20px" name="attachment" placeholder="" class="form-control"  type="text">
								    </div>
								  </div>
								</div>
