						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								...
								<div class="form-group">
								  ...
								  <select id="taxname" name="taxname" style="color:gray;" >
							<option value="0">વેરાનો પ્રકાર
							</option>
							<option value="watertax">પાણી વેરો
							</option>
							<option value="housetax">ઘર વેરો
							</option>
							<option value="streetlighttax">સ્ટ્રીટ લાઈટ વેરો
							</option>
							<option value="bussinesstax">વ્વસાય વેરો
							</option>
							<option value="cleanlinesstax">સફાય વેરો
							</option>
							<option value="Sewerage">ગટર વેરો
							</option>
							...
							<option value="12">December
								...
								<button type="sumit" data-background-color="blue" class="btn btn-large btn-primary" ><fmt:message key="Submit"/></button>
