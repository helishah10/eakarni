						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="orange">
	                                <h4 class="title" style="text-align:center;font-weight: bold;"><fmt:message key="listddos"/></h4>
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    <thead class="text-warning">
	                                        ...
	                                        <Th><fmt:message key="District_Id"/></Th>
	                                    ...
	                                    <tbody>
	                                   <c:forEach var="ddo" items="${Allddos}"> 
	                                        <tr>
	                                        	<td>${ddo.user.loginId}</td>
	                                        	<td>${ddo.district.name}</td>
	                                        	<td>${ddo.startDate}</td>
	                                        	<td>${ddo.leaveDate}</td>
	                                        	<td>${ddo.appointmentLetterNo}</td> 
	                                ...
	                                <!-- <input type="button" onclick="location.href='AddDdo.jsp';" class="btn btn-white btn-round btn-just-icon" value="Add Ddo" style="color:white;background:orange;">
