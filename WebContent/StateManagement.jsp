	...
	<div class="wrapper">
	    ...
	    <div class="sidebar" data-color="purple" data-image="assets/img/sidebar-1.jpg">
	    	...
	    	<div class="sidebar-wrapper">
	            <ul class="nav">
	                <li class="active">
	                    <a href="StateManagement.jsp">
	                        <i class="material-icons">dashboard</i>
	                        <p><b>State Management</b></p>
	                    </a>
	                </li>
	                <li>
	                    <a href="DistrictManagement.jsp">
	                        <i class="material-icons">dashboard</i>
	                        <p><b>District Management</b></p>
	                    </a>
	                </li>
	                <li>
	                    <a href="DDOManagement.jsp">
	                        <i class="material-icons">dashboard</i>
	                        <p>DDO Management</p>
	                    </a>
	                </li>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="card card-stats">
								...
								<div class="card-content">
									<p class="category"><fmt:message key="HSG_1_14_15"/></p>
									<h3 class="title">49/50<small></small></h3>
								</div>
								<!-- <div class="card-footer">
									<div class="stats">
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="card card-stats">
								...
								<div class="card-content">
									...
									<h3 class="title"><small>666</small></h>
								</div>
								<!-- <div class="card-footer">
									<div class="stats">
										<i class="material-icons text-danger">warning</i> <a href="#pablo">Get More Space...</a>
