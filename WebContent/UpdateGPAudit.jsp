...
<fmt:bundle basename="com.zensoftech.eakarni.properties.GPAuditTbl" prefix="">
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<form action="UpdateGpAuditServlet" method="post">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            ...
	                            <form action="UpdateGpAuditServlet" method="post">
	                                <table class="table table-hover">
	                                    <thead class="text-warning" style="color:purple;font-weight:900px;">
	                                        <tr>
												...
												<th class="" style=""><fmt:message key="yearOfRegisteration"/></th>
												<th class="" style=""><fmt:message key="totalPera"/></th>
												<th class="" style=""><fmt:message key="totalPeraAnswered"/></th>
												<th class="" style=""><fmt:message key="totalPeraAnsweredThisWeek"/>  </th>
												<th class="" style=""><fmt:message key="peraNotanswered"/> </th>
											</tr>
	          					  ...
	          					  <tr>
	          					 	<td><%= i %> <% i++; %></td>
											<td><input type="number" name="yearOfRegisteration" id="yearOfRegisteration" value="${peravillage.yearOfRegisteration}"></td>
											<td><input type="number" name="totalPera" id="totalPera" value="${peravillage.totalPera}"></td>
											<td><input type="number" name="totalPeraAnsweredThisWeek" id="totalPeraAnsweredThisWeek" value="${peravillage.totalPeraAnsweredThisWeek}"></td>
											<td><input type="number" name="peraNotanswered" id="peraNotanswered" value="${peravillage.peraNotanswered}" disabled></td>
	                             		           	 
	            				 </tr> 
		
	                                    </tbody>
	                                </table>
	                               <input type="hidden" name="peravillage" value="${peravillage}" />			
