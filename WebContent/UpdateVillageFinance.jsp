...
<div class="content">
				<div class="container-fluid">
					<form action="UpdateFinanceServlet" method="post">
								...
								<tbody> 
	          					<tbody>
								   <% int i = 1; %>
	          					  ...
	          					  <tr>
	          					 	<td><%= i %> <% i++; %></td>
									<td><input type="number" id="totalWork" name="totalWork" value="${financevillage.totalWork}"></td>
									<td><input type="number" id="worksApproved" name="worksApproved" value="${financevillage.worksApproved}"disabled></td>
									<td><input type="number"  id="projectNotStarted" name="projectNotStarted" value="${financevillage.projectNotStarted}"></td>
									<td><input type="number" id="progress" name="progress" value="${financevillage.progress}"></td>
									<td><input type="number" id="completed" name="completed" value="${financevillage.completed}"></td>
									<td><input type="number" id="grantAllocated" name="grantAllocated" value="${financevillage.grantAllocated}" ></td>
									<td><input type="number" id="amountSpent" name="amountSpent" value="${financevillage.amountSpent}"></td>
								</tr>
								
						 </tbody>
     </table>
	         <input type="hidden" name="financevillage" value="${financevillage}" />			
