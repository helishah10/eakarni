...
<fmt:bundle basename="com.zensoftech.eakarni.properties.HsgTbl" prefix="">
<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<form action="UpdateHsgServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <form action="UpdateHsgServlet" method="post">
	                                <table class="table table-hover">
	                                    <thead class="text-warning" style="color:purple;font-weight:900px;">
	                                        <tr>
												...
												<th class="" style=""><fmt:message key="notStartedHouses"/></th>
												<th class="" style=""><fmt:message key="plinthLevel"/> </th>
												<th class="" style=""><fmt:message key="lintalLevel"/></th>
												<th class="" style=""><fmt:message key="slabLevel"/></th>
												<th class="" style=""><fmt:message key="completedHouses"/></th>
											</tr>
									...
									<td style="text-align: CENTER;">1</td>
	                                        	...
	                                        	<td><input id="notStartedHouses" type="number"
																		name="notStartedHouses"
																		value="${hsgvillage.notStartedHouses}"></input></td>
												<td><input id="plinthLevel" type="number"
																		name="plinthLevel"
																		value="${hsgvillage.plinthLevel}"></input></td>
																		<td><input id="lintalLevel" type="number"
																		name="lintalLevel"
																		value="${hsgvillage.lintalLevel}"></input></td>
																		<td><input id="slabLevel" type="number"
																		name="slabLevel"
																		value="${hsgvillage.slabLevel}"></input></td>
																		<td><input id="completedHouses" type="number"
																		name="completedHouses"
																		value="${hsgvillage.completedHouses}"></input></td>
