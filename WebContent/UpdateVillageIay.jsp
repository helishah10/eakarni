	...
	<div class="wrapper">
	  ...
	  <div class="sidebar-wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<form action="UpdateIayServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <form action="UpdateIayServlet" method="post">
									...
									<th class="" style=""><fmt:message key="thirdInstallment"/> </th>
										...
										<td><%=i%> <%i++;%></td>
	                               <td><input type="number" name="target" id="target" value="${iayvillage.target}" disabled></td>
	                               <td><input type="number" name="firstInstallment" id="firstInstallment" value="${iayvillage.firstInstallment}"></td>
	                               <td><input type="number" name="secondInstallment" id="secondInstallment" value="${iayvillage.secondInstallment}"></td>
	                               <td><input type="number" name="thirdInstallment" id="thirdInstallment" value="${iayvillage.thirdInstallment}"></td>
	                               ...
	                               <input type="hidden" name="iayvillage" value="${iayvillage}" />			
