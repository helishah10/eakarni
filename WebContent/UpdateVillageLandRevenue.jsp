...
<body>
	...
	<div class="content">
				<div class="container-fluid">
					<form action="TalatiJaminMehsulServlet" method="post">
								...
								<tbody>
																...
																<tr>
																	...
																	<td><%=i%> <%
 																		i++;
																	 %></td>
									<td><input type="number" id="landRevenue" name="landRevenue" value="${jaminvillage.landRevenue}"></td>
									<td><input type="number" id="totalAmountSeeking" name="totalAmountSeeking" value="${jaminvillage.totalAmountSeeking}"></td>
									<td><input type="number" id="amountCollectedDuringMonth" name="amountCollectedDuringMonth" value="${jaminvillage.amountCollectedDuringMonth}"></td>
									<td><input type="number" id="amountLeft" name="amountLeft" value="${jaminvillage.amountLeft}"></td>
									<td><input type="number" id="percentage" name="percentage" value="${jaminvillage.percentage}" disabled></td>
								</tr>
