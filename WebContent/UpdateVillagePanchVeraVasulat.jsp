...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<form action="UpdatePanchVeraVasulatServlet" method="post">
	          					 			 ...
	          					 			 <%
																...
																<tr>
																	...
																	<td><%=i%> <%
 																		i++;
																	 %></td>
												<td><input type="text" id="taxName" name="taxName" value="${panchveravillage.taxtype.taxName}"></td>
	                              			 	<td><input type="number" id="seekingPreviousAmountLeft" name="seekingPreviousAmountLeft" value="${panchveravillage.seekingPreviousAmountLeft}"></td>
	                               				<td><input type="number" id="seekingCurrentAmount" name="seekingCurrentAmount" value="${panchveravillage.seekingCurrentAmount }"></td>
	                              			    <td><input type="number" id="seekingTotalAmount" name="seekingTotalAmount" value="${panchveravillage.seekingTotalAmount}" disabled></td>
	                               			
	                             			    <td><input type="number" id="recoveryTillPreviousMonthCurrent" name="recoveryTillPreviousMonthCurrent" value="${panchveravillage. recoveryTillPreviousMonthCurrent}"></td>
	                                            <td><input type="number" id="recoveryTillPreviousMonthPrevious" name="recoveryTillPreviousMonthPrevious" value="${panchveravillage. recoveryTillPreviousMonthPrevious }"></td>
	                                            <td><input type="number" id="recoveryTillPreviousMonthTotal" name="recoveryTillPreviousMonthTotal" value="${panchveravillage. recoveryTillPreviousMonthTotal }" disabled></td>
	                                            
	                                             <td><input type="number" id="recoveryTillCurrentMonthCurrent" name="recoveryTillCurrentMonthCurrent" value="${panchveravillage. recoveryTillCurrentMonthCurrent}"></td>
	                                            <td><input type="number" id="recoveryTillCurrentMonthPrevious" name="recoveryTillCurrentMonthPrevious" value="${panchveravillage. recoveryTillCurrentMonthPrevious }"></td>
	                                            <td><input type="number" id="recoveryTillCurrentMonthTotal" name="recoveryTillCurrentMonthTotal" value="${panchveravillage. recoveryTillCurrentMonthTotal }" disabled></td>
	                                            
	                                            <td><input type="number" id="totalRecoveryCurrent" name="totalRecoveryCurrent" value="${panchveravillage.totalRecoveryCurrent }"></td>
	                                            <td><input type="number" id="totalRecoveryPrevious" name="totalRecoveryPrevious" value="${panchveravillage.totalRecoveryPrevious }"></td>
	                                            <td><input type="number" id="totalRecoveryTotal" name="totalRecoveryTotal" value="${panchveravillage.totalRecoveryTotal }"disabled></td>
	                                            
	                                            <td><input type="number" id="recoveryLeftAtTheEndMonthPrevious" name="recoveryLeftAtTheEndMonthPrevious" value="${panchveravillage. recoveryLeftAtTheEndMonthPrevious}"></td>
	                                            <td><input type="number" id="recoveryLeftAtTheEndMonthCurrent" name="recoveryLeftAtTheEndMonthCurrent" value="${panchveravillage. recoveryLeftAtTheEndMonthCurrent }"></td>
	                                            <td><input type="number" id="recoveryLeftAtTheEndMonthTotal" name="recoveryLeftAtTheEndMonthTotal" value="${panchveravillage. recoveryLeftAtTheEndMonthTotal}" disabled></td>
	                                             
	                                             <td><input type="number" id="percentage" name="percentage" value="${panchveravillage.percentage}" disabled></td>
