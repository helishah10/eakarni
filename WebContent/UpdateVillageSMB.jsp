...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<form action="UpdateSmbServlet" method="post">
							...
							<div class="card">
	                           ...
	                           <form action="UpdateSmbServlet" method="post">
								...
								<tr>
												...
												<th class="" style=""><fmt:message key="totalFamilies"/> </th>
												<th class="" style=""><fmt:message key="familiesHavingLavatories"/></th>
												<th class="" style=""><fmt:message key="familiesNotHavingLavatories"/> </th>
												<th class="" style=""><fmt:message key="lavatoriesMadeDuringWeek"/> </th>
										</tr>
								</thead>
								<tbody>
								    ...
								    <td><input type="number" id="totalFamilies" name="totalFamilies" value="${smbvillage.totalFamilies}"></td>
									<td><input type="number" id="" name="familiesHavingLavatories" value="${smbvillage.familiesHavingLavatories}"> </td>
									<td><input type="number" id="familiesNotHavingLavatories" name="familiesNotHavingLavatories" value="${smbvillage.familiesNotHavingLavatories}" disabled> </td>
									<td><input type="number" id="lavatoriesMadeDuringWeek" name="lavatoriesMadeDuringWeek" value="${smbvillage.lavatoriesMadeDuringWeek}"> </td>
	            				 </tr>  
