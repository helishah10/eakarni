...
+
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="DistrcitCdpServlet" method="post">
					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								...
								<tbody>
								 <% int i = 1; %>
	                             <c:forEach var="cdp" items="${cdpDistrictMap}"> 
	          					  <tr>
	          					  <td><%= i %> <% i++; %></td>
	                              <%--  <td>${cdp.key}</td> --%>
	                               <td>${cdp.value.grantAllocated}</td>
	                               <td>${cdp.value. costsDuringPreviousYear}</td>
	                               <td>${cdp.value. costsDuringThisMonth}</td>
	                               <td>${cdp.value.ongoingCostsDuringCurrentYear}</td>
	                               <td>${cdp.value.achievementOfPreviousMonthOfCurrentYear}</td>
	                               <td>${cdp.value.achievementsDuirngThisMonth}</td>
	                               <td>${cdp.value.totalAchievementsOfCurrentYear}</td>
