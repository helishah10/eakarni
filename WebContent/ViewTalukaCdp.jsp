...
+
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="ViewTalukaCdpServlet" method="post">
						...
						<!-- <a href="../report/talukaCdpReport.xls" download><button>report</button></a> -->
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title" style="text-align:center;font-weight:bold;">CDP14</h4>
								...
								<tbody>
								 <% int i = 1; %>  
	                             <c:forEach var="entry" items="${cdpTalukaMap}"> 
	          					  <tr>
	          					 <td><%= i %> <% i++; %></td> 
	                                <%-- <td>${entry.key}</td>  --%>
