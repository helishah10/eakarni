...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="ViewTalukaGramAuditperaServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    ...
	                                    <tbody>
	                                     <% int i = 1; %>
	                                      <c:forEach var="auditpera" items="${peraTalukaMap}"> 
	          					 		 <tr>
	                             			<td><%= i %> <% i++; %></td>
	                              			 <%-- <td>${auditpera.key}</td> --%>
	                              			 <td>${auditpera.value.yearOfRegisteration}</td>
	                              			 <td>${auditpera.value.totalPera}</td>
	                              			 <td>${auditpera.value.totalPeraAnsweredThisWeek}</td>
	                              			 <td>${auditpera.value.peraNotanswered}</td>
	                             		     <td>${auditpera.value.entryDate}</td>         	 
	            				 </tr> 
								</c:forEach>
	                                    </tbody>
	                                </table>
