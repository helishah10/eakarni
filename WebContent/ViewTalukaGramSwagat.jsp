...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="ViewTalukaGramswagatServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    ...
	                                    <tbody>
	                                    	 <% int i = 1; %>
	                                       <c:forEach var="entry" items="${gramswagatMap}"> 
	          					 		 <tr>
	          					 		 	<td><%= i %> <% i++; %></td>
	          					 		 	
	          					 		 	 <td>${entry.value.descriptionOfQuestionsRaised}</td>
				                               <td>${entry.value.disposal}</td>
