...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="ViewTalukaJaminMehsulVeraVasulatServlet" method="post">
						<fmt:message key="month"/>: <select id="month" name="month">
							...
							<option value="12">December						</select> <fmt:message key="year"/>: <input type="number" id="year" name="year" required />
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title" style="text-align:center;font-weight:bold;">Land Revenue</h4>
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    ...
	                                    <tbody>
	                                    <% int i = 1; %>
	                                      <c:forEach var="jamin" items="${jaminTalukaMap}"> 
	          					 		 <tr>
	          					 		 <td><%= i %> <% i++; %></td>
	                              			<%--  <td>${jamin.key}</td> --%>
	                              		 	<td>${jamin.value.landRevenue}</td>
	                               			<td>${jamin.value. totalAmountSeeking}</td>
	                              		    <td>${jamin.value. amountCollectedDuringMonth}</td>
	                            		    <td>${jamin.value.amountLeft}</td>
	                           			    <td>${jamin.value.percentage}</td>
	                              		   <%--   <td>${jamin.value.entryDate}</td>    --%>      	 
	            				 </tr> 
								</c:forEach>
	                                    </tbody>
	                                </table>
