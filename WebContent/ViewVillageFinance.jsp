...
<fmt:bundle basename="com.zensoftech.eakarni.properties.VillageViewFinance" prefix="" >
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="VillageFinanceServlet" method="post">
						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                               ...
	                               <tbody>
	                           		 <% int i = 1; %>
	                            	 <c:forEach var="finance" items="${financeVillageMap}"> 
	          					 		 <tr>
	          					 		 <td><%= i %> <% i++; %></td>
	                             		 <%--  <td>${finance.key}</td> --%>
