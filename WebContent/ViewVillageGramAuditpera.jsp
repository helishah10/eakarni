...
<fmt:bundle basename="com.zensoftech.eakarni.properties.ViewGpAudit" prefix="">
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="GPAuditvillageServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    ...
	                                    <tbody>
	                                     <% int i = 1; %>
	                                      <c:forEach var="auditpera" items="${GpAuditVillageMap}"> 
	          					 		 <tr>
	                             			<td><%= i %> <% i++; %></td>
	                              			 <%-- <td>${auditpera.key}</td> --%>
	                              			 <td>${auditpera.value.yearOfRegisteration}</td>
	                              			 <td>${auditpera.value.totalPera}</td>
	                              			<%--  <td>${auditpera.value.totalPeraAnswered}</td> --%>
