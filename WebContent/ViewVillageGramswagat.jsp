...
<fmt:bundle basename="com.zensoftech.eakarni.properties.ViewGramSwagat" prefix="">
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="VillageGramswagatServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    ...
	                                    <tbody>
	                                    	 <% int i = 1; %>
	                                       <c:forEach var="gramswagat" items="${gramswagatMap}"> 
	          					 		 <tr>
	          					 		 	<td><%= i %> <% i++; %></td>
