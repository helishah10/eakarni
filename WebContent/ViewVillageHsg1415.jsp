...
<fmt:bundle basename="com.zensoftech.eakarni.properties.ViewHsg" prefix="">
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
				<form action="VillageHsg1415Servlet" method="post">
						...
						<fmt:message key="financeYear"/>:<input type="number" id="financeYear" name="financeYear" required/>
							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    ...
	                                    <tbody>
	                                     <% int i = 1; %>  
	                             <c:forEach var="hsg" items="${hsgVillageMap1415}"> 
	          					  <tr>
	          					 <td><%= i %> <% i++; %></td> 
	                                <%-- <td>${entry.key}</td>  --%>
