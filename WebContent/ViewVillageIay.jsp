...
<fmt:bundle basename="com.zensoftech.eakarni.properties.InsertIay" prefix="">
<!doctype html>
<html lang="">
<head>
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper" >
	    ...
	    <div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<form action="VillageIayServlet" method="post">
							...
							<div class="card">
	                            ...
	                            <div class="card-content table-responsive">
									...
									<th class="" style=""><fmt:message key="thirdInstallment"/> </th>
	                                    ...
	                                    <tbody>
	                                    <% int i = 1; %>
	                                         <c:forEach var="iay" items="${iayVillageMap}"> 
	          					  <tr>
	          					  <td><%= i %> <% i++; %></td>
	                               <%-- <td>${iay.key}</td> --%>
