...
<br>
		...
		<input name="region" type="radio" value="village">village</input> 
		<input name="region" type="radio" value="taluka">taluka</input>
		<input name="region" type="radio" value="district">district</input> </h1>
	  </br>-->
