...
<fmt:bundle basename="com.zensoftech.eakarni.properties.UserTDO" prefix="">
<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8" />
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li>
								<a href="/eakarni/TdoDashboardServlet" ><!-- class="dropdown-toggle" data-toggle="dropdown" -->
									<i class="material-icons">dashboard</i>
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-5">
												<div class="form-group label-floating">
													<label class="control-label"><fmt:message key="Taluka"/></label>
													<input type="text" value="${appointmentTdo.taluka.name}"class="form-control" disabled>
												</div>
	                                        </div>
	                                        <div class="col-md-3">
												<div class="form-group label-floating">
													<label class="control-label"><fmt:message key="LoginId"/></label>
													<input type="text" value="${userdetails.user.loginId}" class="form-control" >
												</div>
	                                        </div>
	                                        <div class="col-md-4">
												<div class="form-group label-floating">
