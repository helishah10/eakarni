...
@WebServlet("/TalukaPropertyDetailsServlet")
public class TalukaPropertyDetailsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("submit")!=null)
		{
			...
			try {
				...
				request.setAttribute("talukaPropertyDetails", propertyMap);
			} catch (Exception e) {
				
				e.printStackTrace();
			}
			
			RequestDispatcher rd=request.getRequestDispatcher("ViewTalukamilkatRegister.jsp");
