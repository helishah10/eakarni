...
@WebServlet("/UpdateJaminMehsulServlet")
public class UpdateJaminMehsulServlet extends HttpServlet {
...
System.out.println("in servlet:");
		...
		TalatiJaminMehsulManagerImpl talatilandrevenuemanager=(TalatiJaminMehsulManagerImpl)getServletContext().getAttribute("talatijaminmanager");
		...
		
		{
			...
			jamin=talatilandrevenuemanager.getJaminMehsulVeraVasulatDetailsByMonth(villageId,YearMonth.of(year, month));
		...
		else if(request.getParameter("update")!=null)
		{
			...
			jamin=talatilandrevenuemanager.updateJaminMehsulVeraVasulat(jamin1, autovid,yearmonth);
